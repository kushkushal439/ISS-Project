...
def main():
      ...
      images = [os.path.join('selected', image) for image in os.listdir(os.path.join(app.root_path, 'static', 'selected'))]
...
def logout():
    ...
    shutil.rmtree('/home/kushal/coding/project1/final_project/ISS-Project/static/images')
    if os.path.exists('/home/kushal/coding/project1/final_project/ISS-Project/static/selected'): shutil.rmtree('/home/kushal/coding/project1/final_project/ISS-Project/static/selected')
